...
if (!function_exists("AddPofApiCustomPostTypes")) {
	require_once( get_template_directory() . '/pofapiwp_customPostTypes.php');
}

if (!function_exists("AddPofApiCustomTaxonomies")) {
	require_once( get_template_directory() . '/pofapiwp_customTaxonomies.php');
}
